...
;; @@
(mh/publish local-conn "topic/test1" "Hello from linode gorilla t/t1")
;; @@
;; =>
;;; {"type":"html","content":"<span class='clj-nil'>nil</span>","value":"nil"}
;; <=
...
;; @@
(mh/publish local-conn "topic/test2" "Hello from linode gorilla t/t2")
;; @@
;; =>
;;; {"type":"html","content":"<span class='clj-nil'>nil</span>","value":"nil"}
;; <=
...
;; @@
;; test MQTT Kafka Connector and Kafka to RethinkDB Connector
(mh/publish local-conn "/mjson" (str "{\"deviceId\":2,\"value\":62.2,\"region\":\"NA\",\"timestamp\":" (.getTime (java.util.Date.)) "}"))
;; @@
;; =>
;;; {"type":"html","content":"<span class='clj-nil'>nil</span>","value":"nil"}
;; <=
