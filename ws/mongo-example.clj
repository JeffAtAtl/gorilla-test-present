...
;; @@
;; =>
;;; {"type":"list-like","open":"<span class='clj-lazy-seq'>(</span>","close":"<span class='clj-lazy-seq'>)</span>","separator":" ","items":[{"type":"html","content":"<span class='clj-string'>&quot;local&quot;</span>","value":"\"local\""},{"type":"html","content":"<span class='clj-string'>&quot;mydb&quot;</span>","value":"\"mydb\""}],"value":"(\"local\" \"mydb\")"}
;; <=
...
;; @@
;; =>
;;; {"type":"list-like","open":"<span class='clj-lazy-seq'>(</span>","close":"<span class='clj-lazy-seq'>)</span>","separator":" ","items":[{"type":"html","content":"<span class='clj-string'>&quot;points&quot;</span>","value":"\"points\""},{"type":"html","content":"<span class='clj-string'>&quot;robots&quot;</span>","value":"\"robots\""},{"type":"html","content":"<span class='clj-string'>&quot;system.indexes&quot;</span>","value":"\"system.indexes\""},{"type":"html","content":"<span class='clj-string'>&quot;words&quot;</span>","value":"\"words\""},{"type":"html","content":"<span class='clj-string'>&quot;words1&quot;</span>","value":"\"words1\""}],"value":"(\"points\" \"robots\" \"system.indexes\" \"words\" \"words1\")"}
;; <=
...
;; @@
;; =>
;;; {"type":"list-like","open":"<span class='clj-lazy-seq'>(</span>","close":"<span class='clj-lazy-seq'>)</span>","separator":" ","items":[{"type":"list-like","open":"<span class='clj-map'>{</span>","close":"<span class='clj-map'>}</span>","separator":", ","items":[{"type":"list-like","open":"","close":"","separator":" ","items":[{"type":"html","content":"<span class='clj-keyword'>:word</span>","value":":word"},{"type":"html","content":"<span class='clj-string'>&quot;reseat&quot;</span>","value":"\"reseat\""}],"value":"[:word \"reseat\"]"},{"type":"list-like","open":"","close":"","separator":" ","items":[{"type":"html","content":"<span class='clj-keyword'>:length</span>","value":":length"},{"type":"html","content":"<span class='clj-unkown'>6</span>","value":"6"}],"value":"[:length 6]"},{"type":"list-like","open":"","close":"","separator":" ","items":[{"type":"html","content":"<span class='clj-keyword'>:freq</span>","value":":freq"},{"type":"list-like","open":"<span class='clj-map'>{</span>","close":"<span class='clj-map'>}</span>","separator":", ","items":[{"type":"list-like","open":"","close":"","separator":" ","items":[{"type":"html","content":"<span class='clj-keyword'>:t</span>","value":":t"},{"type":"html","content":"<span class='clj-long'>1</span>","value":"1"}],"value":"[:t 1]"},{"type":"list-like","open":"","close":"","separator":" ","items":[{"type":"html","content":"<span class='clj-keyword'>:s</span>","value":":s"},{"type":"html","content":"<span class='clj-long'>1</span>","value":"1"}],"value":"[:s 1]"},{"type":"list-like","open":"","close":"","separator":" ","items":[{"type":"html","content":"<span class='clj-keyword'>:r</span>","value":":r"},{"type":"html","content":"<span class='clj-long'>1</span>","value":"1"}],"value":"[:r 1]"},{"type":"list-like","open":"","close":"","separator":" ","items":[{"type":"html","content":"<span class='clj-keyword'>:e</span>","value":":e"},{"type":"html","content":"<span class='clj-long'>2</span>","value":"2"}],"value":"[:e 2]"},{"type":"list-like","open":"","close":"","separator":" ","items":[{"type":"html","content":"<span class='clj-keyword'>:a</span>","value":":a"},{"type":"html","content":"<span class='clj-long'>1</span>","value":"1"}],"value":"[:a 1]"}],"value":"{:t 1, :s 1, :r 1, :e 2, :a 1}"}],"value":"[:freq {:t 1, :s 1, :r 1, :e 2, :a 1}]"},{"type":"list-like","open":"","close":"","separator":" ","items":[{"type":"html","content":"<span class='clj-keyword'>:_id</span>","value":":_id"},{"type":"html","content":"<span class='clj-unkown'>#object[org.bson.types.ObjectId 0x1552e822 &quot;55a2bf8bca72bb126dc51977&quot;]</span>","value":"#object[org.bson.types.ObjectId 0x1552e822 \"55a2bf8bca72bb126dc51977\"]"}],"value":"[:_id #object[org.bson.types.ObjectId 0x1552e822 \"55a2bf8bca72bb126dc51977\"]]"}],"value":"{:word \"reseat\", :length 6, :freq {:t 1, :s 1, :r 1, :e 2, :a 1}, :_id #object[org.bson.types.ObjectId 0x1552e822 \"55a2bf8bca72bb126dc51977\"]}"}],"value":"({:word \"reseat\", :length 6, :freq {:t 1, :s 1, :r 1, :e 2, :a 1}, :_id #object[org.bson.types.ObjectId 0x1552e822 \"55a2bf8bca72bb126dc51977\"]})"}
;; <=
...
;;;   :vcount 3,
;;;   :vfreq {:a 2, :o 1},
;;;   :_id #&lt;ObjectId 55a23459ca72bb126dbef7ac&gt;})
;;; 
;; <-
;; =>
;;; {"type":"html","content":"<span class='clj-nil'>nil</span>","value":"nil"}
